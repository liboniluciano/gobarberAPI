...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    // Barrando um usuário de criar agendamento para ele mesmo
    if (req.userId === provider_id) {
      return res
        .status(401)
        .json({ error: 'Você não pode fazer agendamentos para si mesmo' });
    }
    ...
    // Notificando o provider do agendamento
  ...
  async delete(req, res) {
    ...
    if (appointment === null) {
      return res
        .status(401)
        .json({ error: `This appointment ${req.params.id} does not exists` });
    }

    // Verificando se o usuário que vai cancelar é o dono do agendamento
    ...
    // Verificando se o horário do cancelamento é antes de 2hrs
